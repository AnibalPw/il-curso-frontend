            ...
            <div className="mx-auto px-4 sm:px-6"> {/* max-w-7xl */}
                <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                    ...
                    <nav className="hidden md:flex space-x-10">
                            ...
                            >
                                ...
                                {/* <div className="absolute -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                                    <div className="rounded-lg shadow-lg">
                                        ...
                                        <NavLink to='/' href="#" className="-m-3 p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 transition ease-in-out duration-150">
                                        ...
                                        <div className="flow-root">
                                            <NavLink to='/' href="#" className="-m-3 p-3 flex items-center space-x-3 rounded-md text-base leading-6 font-medium text-gray-900 hover:bg-gray-100 transition ease-in-out duration-150">
                        ...
                        {/* <NavLink to='/' href="#" className="text-base leading-6 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150">
                        Pricing
                        </ NavLink>
                        <NavLink to='/' href="#" className="text-base leading-6 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150">
                        Docs
                        ...
                        onClick={() => setIsMoreOpen(!isMoreOpen)}>
                            ...
                            <Transition 
                                ...
                                {/* <div className="absolute left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
                                    ...
                                    <div className="rounded-lg shadow-xs overflow-hidden">
                                        <div className="z-20 relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                        <NavLink to='/'  className="-m-3 p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 transition ease-in-out duration-150">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <li className="text-base leading-6 truncate">
                                                <NavLink to='/' href="#" className="font-medium text-gray-900 hover:text-gray-700 transition ease-in-out duration-150">
                                        ...
                                        <div className="text-sm leading-5">
                                            <NavLink to='/' href="#" className="font-medium text-indigo-600 hover:text-indigo-500 transition ease-in-out duration-150">
                                            View all posts &rarr;
                                            </ NavLink>
                                        </div>
                                        </div>
                    ...
                    </nav>
                    {
                        ...
                        <div className="hidden md:flex items-center justify-end space-x-8 md:flex-1 lg:w-0">
                            ...
                            <Link to='/auth/signin' className="whitespace-no-wrap text-base leading-6 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900">
                                Iniciar sesión
                            </Link>
                            <span className="inline-flex rounded-md shadow-sm">
                                <Link to='/auth/signup' className="whitespace-no-wrap inline-flex items-center justify-center px-4 py-2 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700 transition ease-in-out duration-150">
                                    Registrarse
                                </Link>
                            </span>
                        </div>
                        ...
                        <div className="hidden md:flex items-center justify-end space-x-8 md:flex-1 lg:w-0">
                            ...
                            <button onClick={handleLogout}  className="block w-full px-3 py-2 rounded-md text-base font-medium 
                            text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white 
                            focus:bg-gray-700">Cerra sesión</button>
                        </div>
                    }
                </div>
            </div>
                        ...
                        <div className="rounded-lg shadow-xs bg-white divide-y-2 divide-gray-50">
                            <div className="pt-5 pb-6 px-5 space-y-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        {/* <img className="h-8 w-auto" src="https://tailwindui.com/img/logos/v1/workflow-mark-on-white.svg" alt="Workflow" /> */}
                                ...
                                {/* <div>
                                    <nav className="grid gap-y-8">
                                        <NavLink to='/' href="#" className="-m-3 p-3 flex items-center space-x-3 rounded-md hover:bg-gray-50 transition ease-in-out duration-150">
                                ...
                                <div className="pt-2 space-y-6 border-t border-gray-200">
                                    ...
                                    <div className="w-full flex rounded-md shadow-sm">
                                        ...
                                        className="w-full flex items-center justify-center
                                         px-4 py-2 border border-transparent text-base 
                                    ...
                                    <div className="flex justify-center items-center dark:text-white">
                                        <p className="text-center text-base leading-6 font-medium text-gray-500 mr-24">¿Ya tienes una cuenta?</p>
                                        <Link to="/auth/signin"
                                            className="no-underline hover:underline 
                                            text-indigo-500 dark:text-white text-md 
                                            text-right absolute flex items-center justify-center 
                                            w-full max-w-xs font-bold shadow-sm"
                                        >
                                            <span className='ml-44'>Iniciar sesión</span> 
                                        </Link>
                                    </div>
                                </div>
                                :
